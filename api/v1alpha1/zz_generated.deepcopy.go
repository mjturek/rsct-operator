...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodePodStatus) DeepCopyInto(out *NodePodStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodePodStatus.
func (in *NodePodStatus) DeepCopy() *NodePodStatus {
	if in == nil {
		return nil
	}
	out := new(NodePodStatus)
	in.DeepCopyInto(out)
	return out
}
